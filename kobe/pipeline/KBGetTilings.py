...
class PstGetTilings():
        ...
        def remove_fileds_coo(self, ra, dec, fovra, fovdec,
                ...
                idtiles = PstGetTilings.ipix_in_box(self.data['ra'], self.data['dec'],
                                self.data['fovra'],self.data['fovdec'],self.conf['nside'],
                                self.conf['nest'])                        
                idhpx = PstGetTilings.ipix_in_box(np.array(ra), np.array(dec), np.array(fovra),
        ...
        def common_ele(list1, list2, nullv=-99):
                ...
                ele :     sequence
                  common elements
                """               
                list1 = PstGetTilings.flatten(list1, nullv=nullv)
                list2 = PstGetTilings.flatten(list2, nullv=nullv)
