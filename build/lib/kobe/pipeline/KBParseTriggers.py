#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File              : kobe/pipeline/KBParseTriggers.py
...
__all__ = ('KBParseTriggers')

class KBParseTriggers():
    """KBParseTriggers: Read and process trigger healpix map from a given source
    ...
    def resetall(self):
        """  reset all of KBParseTriggers.data
        """
        self.__init__()

    def reset(self, _k):
        """  reset part of KBParseTriggers.data
