#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File              : pst/pipeline/KBPrioritization.py
...
__all__ = ('KBPrioritization')

class KBPrioritization():
    """KBPrioritization: optimize searching strategy considering probability and visibility
    ...
    * implement the following functions:
    ...
    Examples
    --------
    see also https://github.com/saberyoung/kobe/blob/master/notebook/test_prio.ipynb
