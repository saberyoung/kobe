...
class galaxies:
        """KBGetGalaxies: Generate, read and process galaxies
        ...
        defconf :    `dict`           
          default configure, if any KBGetGalaxies parameter was included in defconf dictionary, 
        ...
        Examples
        --------
        see also https://github.com/saberyoung/kobe/blob/master/notebook/test_galaxies.ipynb
        
        >>> from kobe.pipeline.Galaxies import KBGetGalaxies
        >>> a = Galaxies()
        >>> a.data
        """ 
        ...
        def hpmap_mass(self, nside=None, nest=None):
        ...
        def read(self, filename=None, filetype=None, wdir=None):
                ...
                >>> from kobe.pipeline.KBGetGalaxies import KBGetGalaxies
                >>> a = KBGetGalaxies()
                >>> a.read(filename='kobe_galaxies', filetype='npz', wdir='./')
                """
